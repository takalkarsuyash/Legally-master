              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-4">
                    ...
                    />
                    <div>
                      <h3 className="text-lg font-bold text-gray-900 group-hover:text-primary transition-colors line-clamp-1">{lawyer.name}</h3>
                      <p className="text-xs font-medium text-primary uppercase tracking-wide">{lawyer.specialization}</p>
                    </div>
                  </div>
                  {lawyer.rating ? (
                    <div className="flex items-center bg-yellow-100 px-2 py-1 rounded-lg">
                      <Star className="w-3 h-3 text-yellow-500 mr-1 fill-current" />
                      <span className="text-xs font-bold text-yellow-700">{lawyer.rating}</span>
                    </div>
                  ) : null}
                </div>
